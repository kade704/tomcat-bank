    ...
    <main class="ml-64 mt-4 w-lg">
        ...
        <div class="bg-base-200 p-8 border-base-300 rounded-box border shadow flex flex-col gap-4">
            <div class="w-full join">
                <a href="${pageContext.request.contextPath}/transaction/deposit?accountId=${account.id}" class="flex-1 btn join-item btn-primary">입금</a>
            ...
            <form action="/transaction/deposit" method="post">
                ...
                <div>
                    <label class="text-xs">입금할 금액</label>
                ...
                <button type="submit" class="w-full btn btn-primary mt-4">입금</button>
            </form>
