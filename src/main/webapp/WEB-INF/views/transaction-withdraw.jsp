    ...
    <main class="ml-64 mt-4 w-lg">
        ...
        <div class="bg-base-200 p-8 border-base-300 rounded-box border shadow flex flex-col gap-4">
            <div class="w-full join">
                ...
                <a href="${pageContext.request.contextPath}/transaction/withdraw?accountId=${account.id}" class="flex-1 btn join-item btn-secondary">출금</a>
                <a href="${pageContext.request.contextPath}/transaction/transfer?accountId=${account.id}" class="flex-1 btn join-item">이체</a>
            </div>
            ...
            <form action="/transaction/withdraw" method="post">
                ...
                <div>
                    <label class="text-xs">출금할 금액</label>
                ...
                <button type="submit" class="w-full btn btn-secondary mt-4">출금</button>
            </form>
